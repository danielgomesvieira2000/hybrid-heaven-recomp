...
#
# Settings and saves live in $XDG_DATA_HOME/hybrid-heaven-recomp, or
# ~/.local/share/hybrid-heaven-recomp. Put a file called portable.txt next to this
# script to keep them here instead.
set -euo pipefail
cd "$(dirname "$(readlink -f "${BASH_SOURCE[0]}")")"
exec ./hybrid-heaven-recomp "$@"
"""

NOTES = """Hybrid Heaven: Recompiled -- Linux x86-64
=========================================

Run ./hybrid-heaven-recomp.sh and pick your own Hybrid Heaven (USA) dump in the
...
Settings and saves live in $XDG_DATA_HOME/hybrid-heaven-recomp, or
~/.local/share/hybrid-heaven-recomp. A file called portable.txt beside the
