...
#
#   powershell -File tools/capture_window.ps1 -Title "Game: Recompiled" -OutDir shots -Count 12 -IntervalSeconds 5

param(
    [Parameter(Mandatory = $true)][string]$Title,   # the port's exact window title
    [string]$OutDir = "shots",
    [int]$Count = 10,
