...
no loaded module::
    ...
    [hh] recomp::start returned -- runtime shut down
    [hh] shutting down: controller
    [hh] shutting down: window
    [hh] ==== CRASH ====
    [hh] ACCESS_VIOLATION (0xC0000005) at 0000019704441630
    [hh] while executing address 0x19704441630
...
MARKER = "hh: the SDL event filter has to come back off"
